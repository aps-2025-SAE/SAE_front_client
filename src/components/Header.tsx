            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <Link href="/#calendario" className="text-foreground hover:text-accent transition-colors">
                            Disponibilidade
                        </Link>
                        <Link href="/galeria" className="text-foreground hover:text-accent transition-colors">
                            Galeria
                        </Link>
